          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div>
                ...
                <p className="font-semibold">{assessment.deadline || 'Not set'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Data Types</p>
                <p className="font-semibold">{assessment.dataTypes || 'Not specified'}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Data Subjects</p>
                <p className="font-semibold">{assessment.dataSubjects || 'Not specified'}</p>
              </div>
            </div>
            ...
            {assessment.aiDescription && (
              <div className="bg-blue-50 rounded-lg p-4 mb-6">
                ...
                <p className="text-gray-700 text-sm">{assessment.aiDescription}</p>
              </div>
            )}
